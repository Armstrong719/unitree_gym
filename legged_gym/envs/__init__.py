...
from legged_gym.envs.g1_ulc.g1_ulc_config import G1ULCRoughCfg, G1ULCRoughCfgPPO
from legged_gym.envs.g1_ulc.g1_ulc_env import G1ULCRobot
...
task_registry.register( "g1_ulc", G1ULCRobot, G1ULCRoughCfg(), G1ULCRoughCfgPPO())
